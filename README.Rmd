...
not_implemented <- dplyr::filter(status, !implemented)
...
These `r nrow(not_implemented)` keywords currently doesn't have a modifying function, but most of them can be implemented.
```{r, echo = FALSE}
not_implemented %>%
  dplyr::select(-implemented) %>% 
  print(row.names = FALSE)
