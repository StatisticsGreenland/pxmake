test_that("px file and pxsave(px(px file)) are equivalent", {
  ...
  run_px_pxsave_pxjob_and_compare <- function(table_name) {
  ...
  run_px_pxsave_pxjob_and_compare("SOXATI4")
  run_px_pxsave_pxjob_and_compare("BEXSTA_windows_1252")
  run_px_pxsave_pxjob_and_compare("no_timeval_or_codes2")
  run_px_pxsave_pxjob_and_compare("CONTVARIABLE")
  run_px_pxsave_pxjob_and_compare("CONTVARIABLE_multiple_languages")
  run_px_pxsave_pxjob_and_compare("TUX01")
})
