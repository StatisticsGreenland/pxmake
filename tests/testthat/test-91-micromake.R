test_that("micromake runs without errors and creates px files", {
  ...
  test_file_creation2 <- function(table_name) {
  ...
  test_file_creation2("BEXSTA")
  test_file_creation2("FOTEST")
  test_file_creation2("no_timeval_or_codes")
  test_file_creation2("zero_heading")
  test_file_creation2("zero_stub")
})
...
test_that("micromake creates valid px files", {
  ...
  expect_that_pxjob_runs_without_errors("BEXSTA")
