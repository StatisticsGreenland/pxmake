...
`px_micro()` turns a px object into many smaller px files, each containing a few of the variables in the original px object.

## Use case

Some statistical offices use small px files like this, to showcase a lager data set which cannot be made publicly available. See an example on [Statistic Greenland's microdata for Research and Analysis](https://bank.stat.gl/pxweb/en/GSmicro/).
