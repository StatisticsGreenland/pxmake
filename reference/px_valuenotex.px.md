...
- value:
  ...
  Optional. A data frame with the columns 'valuenotex' and one or more
  of the columns: 'variable-code', 'code', and 'language'. If 'value' is
  missing, the current VALUENOTEX is returned. If NULL, VALUENOTEX is
  removed.
...
[Statistics Sweden's
documentation](https://www.scb.se/globalassets/vara-tjanster/px-programmen/px-file_format_specification_2013.pdf#%5B%7B%22num%22%3A56%2C%22gen%22%3A0%7D%2C%7B%22name%22%3A%22XYZ%22%7D%2C184%2C626%2C0%5D)
